...
const (
	ConflictResolution_UseAlpha ConflictResolution = 0
	ConflictResolution_UseBeta  ConflictResolution = 1
)

var ConflictResolution_name = map[int32]string{
	0: "UseAlpha",
	1: "UseBeta",
}
var ConflictResolution_value = map[string]int32{
	"UseAlpha": 0,
	"UseBeta":  1,
}

func (x ConflictResolution) String() string {
	return proto.EnumName(ConflictResolution_name, int32(x))
}
func (ConflictResolution) EnumDescriptor() ([]byte, []int) { return fileDescriptorSync, []int{1} }
...
func init() {
	...
	proto.RegisterEnum("sync.ConflictResolution", ConflictResolution_name, ConflictResolution_value)
}
...
var fileDescriptorSync = []byte{
	...
	,
}

...
// commandNameOrPath returns the name or path specification to use for invoking
...
func commandNameOrPath() (string, error) {
	...
	return commandNameOrPathForPlatform()
}
...
func Command(ctx context.Context, args ...string) (*exec.Cmd, error) {
	...
	nameOrPath, err := commandNameOrPath()
	if err != nil {

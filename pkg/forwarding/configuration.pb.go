...
type Configuration struct {
	...
	// is used.
	AgentDirectory string `protobuf:"bytes,61,opt,name=agentDirectory,proto3" json:"agentDirectory,omitempty"`
...
const file_forwarding_configuration_proto_rawDesc = "" +
	...
	"forwarding\x1a&forwarding/socket_overwrite_mode.proto\"\x82\x02\n" +
	"\rConfiguration\x12Q\n" +
	...
	"\x14socketPermissionMode\x18, \x01(\rR\x14socketPermissionMode\x12&\n" +
	"\x0eagentDirectory\x18= \x01(\tR\x0eagentDirectoryB.Z,github.com/mutagen-io/mutagen/pkg/forwardingb\x06proto3"

...
type Configuration struct {
	...
	// invocation on the endpoint. If empty, the default location (~/.mutagen)
	// is used.
	AgentDirectory string `protobuf:"bytes,91,opt,name=agentDirectory,proto3" json:"agentDirectory,omitempty"`
...
func (x *Configuration) GetAgentDirectory() string {
	if x != nil {
		return x.AgentDirectory
	}
	return ""
}
...
const file_synchronization_configuration_proto_rawDesc = "" +
	...
	"\x14compressionAlgorithm\x18Q \x01(\x0e2\x16.compression.AlgorithmR\x14compressionAlgorithm\x12&\n" +
	"\x0eagentDirectory\x18[ \x01(\tR\x0eagentDirectoryB3Z1github.com/mutagen-io/mutagen/pkg/synchronizationb\x06proto3"

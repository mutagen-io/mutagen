...
func TestIgnorerBasic(t *testing.T) {
	test := &ignoretest.TestCase{
		...
		Tests: []ignoretest.TestValue{
			...
			{Path: "subpath/something", Directory: false, ExpectedStatus: ignore.IgnoreStatusUnignored, ExpectedContinueTraversal: false},
			{Path: "subpath/something", Directory: true, ExpectedStatus: ignore.IgnoreStatusUnignored, ExpectedContinueTraversal: false},
			...
			{Path: "subpath/otherthing", Directory: false, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			{Path: "subpath/otherthing", Directory: true, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			...
			{Path: "somedir", Directory: false, ExpectedStatus: ignore.IgnoreStatusNominal, ExpectedContinueTraversal: false},
			...
			{Path: "subpath/somedir", Directory: true, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			{Path: "ignored", Directory: false, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			{Path: "ignored", Directory: true, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			{Path: "ignored/subpath2", Directory: false, ExpectedStatus: ignore.IgnoreStatusNominal, ExpectedContinueTraversal: false},
			{Path: "ignored/subpath2", Directory: true, ExpectedStatus: ignore.IgnoreStatusNominal, ExpectedContinueTraversal: false},
		},
	}
	test.Run(t)
}
...
func TestIgnoreGroup(t *testing.T) {
	test := &ignoretest.TestCase{
		...
		Tests: []ignoretest.TestValue{
			...
			{Path: "subpath/run.pyd", Directory: false, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			{Path: "subpath/run.pyd", Directory: true, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
			...
			{Path: "run.dirc", Directory: false, ExpectedStatus: ignore.IgnoreStatusNominal, ExpectedContinueTraversal: false},
			...
			{Path: "subpath/run.dird", Directory: true, ExpectedStatus: ignore.IgnoreStatusIgnored, ExpectedContinueTraversal: false},
		},
	}
	test.Run(t)
}
...
func TestIgnoreRootRelative(t *testing.T) {
	test := &ignoretest.TestCase{
		...
		Tests: []ignoretest.TestValue{
			...
			{Path: "absdir", Directory: false, ExpectedStatus: ignore.IgnoreStatusNominal, ExpectedContinueTraversal: false},

...
func TestIgnorerBasic(t *testing.T) {
	test := &ignoretest.TestCase{
		...
		Tests: []ignoretest.TestValue{
			...
			{"subpath/something", true, ignore.IgnoreStatusUnignored, false},
			...
			{"ignored", true, ignore.IgnoreStatusIgnored, false},
			{"ignored/subpath2", false, ignore.IgnoreStatusNominal, false},
			{"ignored/subpath2", true, ignore.IgnoreStatusNominal, false},
		},
	}
	test.Run(t)
}

...
func (pm *PatternMatcher) MatchesForMutagen(path string, directory bool) (MatchStatus, bool) {
	...
	// can immediately recommend continuedTraversal. This is a bit redundant and
	// doesn't have any effect on real code paths, but it is a requirement of
	// the ignorer interface that we're supporting.

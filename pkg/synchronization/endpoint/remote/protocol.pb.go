...
func (m *TransitionCompletionRequest) Reset()         { *m = TransitionCompletionRequest{} }
func (m *TransitionCompletionRequest) String() string { return proto.CompactTextString(m) }
...
func (m *TransitionCompletionRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransitionCompletionRequest.Unmarshal(m, b)
}
func (m *TransitionCompletionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransitionCompletionRequest.Marshal(b, m, deterministic)
}
func (m *TransitionCompletionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransitionCompletionRequest.Merge(m, src)
}
func (m *TransitionCompletionRequest) XXX_Size() int {
	return xxx_messageInfo_TransitionCompletionRequest.Size(m)
}
func (m *TransitionCompletionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TransitionCompletionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TransitionCompletionRequest proto.InternalMessageInfo
...
func (*EndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed323a11ce40f0df, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*TransitionCompletionRequest)(nil), "remote.TransitionCompletionRequest")
...
var fileDescriptor_ed323a11ce40f0df = []byte{
	...
	,
}

...
type EndpointState struct {
	...
	DirectoryCount uint64 `protobuf:"varint,2,opt,name=directoryCount,proto3" json:"directoryCount,omitempty"`
	// FileCount is the number of synchronizable file entries contained in the
	// last snapshot from the endpoint.
	FileCount uint64 `protobuf:"varint,3,opt,name=fileCount,proto3" json:"fileCount,omitempty"`
	// SymbolicLinkCount is the number of synchronizable symbolic link entries
	// contained in the last snapshot from the endpoint.
	SymbolicLinkCount uint64 `protobuf:"varint,4,opt,name=symbolicLinkCount,proto3" json:"symbolicLinkCount,omitempty"`
	// TotalFileSize is the total size of all synchronizable files referenced by
	// the last snapshot from the endpoint.
	TotalFileSize uint64 `protobuf:"varint,5,opt,name=totalFileSize,proto3" json:"totalFileSize,omitempty"`
	...
	ScanProblems []*core.Problem `protobuf:"bytes,6,rep,name=scanProblems,proto3" json:"scanProblems,omitempty"`
	...
	ExcludedScanProblems uint64 `protobuf:"varint,7,opt,name=excludedScanProblems,proto3" json:"excludedScanProblems,omitempty"`
	...
	// non-zero.
	TransitionProblems []*core.Problem `protobuf:"bytes,8,rep,name=transitionProblems,proto3" json:"transitionProblems,omitempty"`
	...
	ExcludedTransitionProblems uint64 `protobuf:"varint,9,opt,name=excludedTransitionProblems,proto3" json:"excludedTransitionProblems,omitempty"`
	// StagingProgress is the rsync staging progress. It is non-nil if and only
	// if the endpoint is currently staging files.
	StagingProgress *rsync.ReceiverStatus `protobuf:"bytes,10,opt,name=stagingProgress,proto3" json:"stagingProgress,omitempty"`
}
...
func (x *EndpointState) GetDirectoryCount() uint64 {
	if x != nil {
...
func (x *EndpointState) GetFileCount() uint64 {
	if x != nil {
		return x.FileCount
	}
	return 0
...
func (x *EndpointState) GetSymbolicLinkCount() uint64 {
	if x != nil {
...
func (x *EndpointState) GetStagingProgress() *rsync.ReceiverStatus {
	if x != nil {
...
var file_synchronization_state_proto_rawDesc = []byte{
	...
	0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xee, 0x03, 0x0a, 0x0d,
	...
	,
...
var file_synchronization_state_proto_goTypes = []interface{}{
	...
	(*rsync.ReceiverStatus)(nil), // 4: rsync.ReceiverStatus
...
var file_synchronization_state_proto_depIdxs = []int32{
	...
	4, // 2: synchronization.EndpointState.stagingProgress:type_name -> rsync.ReceiverStatus

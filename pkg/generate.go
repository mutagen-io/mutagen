...
//go:generate protoc --plugin=./protoc-gen-go -I. --go_out=paths=source_relative,plugins=grpc:. session/configuration.proto session/scan_mode.proto session/session.proto session/stage_mode.proto session/state.proto session/version.proto session/watch_mode.proto
//go:generate protoc --plugin=./protoc-gen-go -I. --go_out=paths=source_relative,plugins=grpc:. session/endpoint/remote/protocol.proto

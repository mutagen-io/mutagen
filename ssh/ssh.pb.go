...
func (m *PromptRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Message) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSsh(dAtA, i, uint64(len(m.Message)))
...
var fileDescriptorSsh = []byte{
	...
	0xec, 0xb9, 0xa9, 0xc5, 0xc5, 0x89, 0xe9, 0xa9, 0x12, 0x4c, 0x60, 0x29, 0x18, 0x57, 0x48, 0x8c,
	...
	0x62, 0x03, 0x07, 0x92, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x3f, 0xb7, 0xdf, 0x20, 0x31, 0x01,
	0x00, 0x00,
}
